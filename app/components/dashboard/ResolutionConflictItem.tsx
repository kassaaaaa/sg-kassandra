  ...
  return (
    <Card>
      ...
      <CardContent className="grid gap-4">
        <div>
          <p>
            <strong>Customer:</strong> {customer?.full_name || "N/A"}
          </p>
          <p>
            <strong>Instructor:</strong> {instructor?.full_name || "N/A"}
          </p>
          <p>
            <strong>Time:</strong> {format(new Date(start_time), "PPP p")}
          </p>
        </div>
          ...
          <Dialog open={isRebookModalOpen} onOpenChange={setRebookModalOpen}>
            ...
            <DialogContent>
              ...
              <DialogFooter>
                ...
                <Button onClick={() => setRebookModalOpen(false)}>
                  Confirm Rebooking
                </Button>
              </DialogFooter>
            </DialogContent>
